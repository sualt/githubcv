...
<head>
    ...
    <title>GİTHUBA ATMAK İÇİN OLUŞTURDUĞUM CV PROJESİ</title>
...
<body>
    ...
    <div class="containerw3layouts-agileits">
        ...
        <div id="verticalTab" class="resp-vtabs w3-agile" style="display: block; width: 100%; margin: 0px;">
            ...
            <ul class="resp-tabs-list agileits-w3layouts">
                ...
                <li class="resp-tab-item"><span>Deneyimler</span></li>
                <li class="resp-tab-item agileinfo"><span>Eğitim</span></li>
                <li class="resp-tab-item"><span>Beceriler</span></li>
                        ...
                        <div class="agileabout-info">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="li2">:</div>
                                    <div class="li3 w3-agileits">'{{ $about->adress }}'</div>
                    ...
                    <div class="our-skills">
                        @foreach ($skills as $ski)
                            <div class="single-skill">
                                ...
                                <p class="lead">{{ $ski->name }}</p>
                                <div class="progress">
                                    <div class="progress-bar progress-bar-1">{{ $ski->skills_percent }}</div>
                                </div>
                        @endforeach
    ...
    <div class="w3lsfooteragileits">
        <p> &copy; 2024 YILINDA OLUŞTURDUĞUM PROJEM. All Rights Reserved | Design by <a href="http://slmnaltunok.com"
                target="=_blank">SÜLEYMAN ALTUNOK</a></p>
    </div>
